# cloud-itonami-iso3166-ury

Open ISO 3166 Blueprint for **URY**: Uruguay.
...
tax registration, and local-content rules in Uruguay, so the operator
...
- **Not the government of Uruguay.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Uruguayan-licensed counsel
...
(ISO 3166 `URY`). Required capabilities:
...
crafts, festivals and heritage sites for Uruguay:
